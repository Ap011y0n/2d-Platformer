...
bool j1Map::CleanUp()
{
	...
	// Remove all layers
	p2List_item<Layer*>* layersitem;
	layersitem = data.layers.start;
...
bool j1Map::Load(const char* file_name)
{
	...
	image = App->tex->Load("maps/tmw_desert_spacing.png");
...
bool j1Map::LoadLayer(pugi::xml_node& node, Layer* layer)
{
	...
	memset(layer->tilegid, 0, layer->width*layer->height*sizeof(int));
